...
_lr_productions = [
  ...
  ('lexico -> lexico comandos','lexico',2,'p_lexico','gramar.py',141),
  ('lexico -> comandos','lexico',1,'p_lexico','gramar.py',142),
  ('comandos -> maincomando subcomando','comandos',2,'p_comandos','gramar.py',152),
  ('comandos -> maincomando','comandos',1,'p_comandos','gramar.py',153),
  ('maincomando -> CONFIGURE','maincomando',1,'p_main_comando','gramar.py',168),
  ('maincomando -> CREATE','maincomando',1,'p_main_comando','gramar.py',169),
  ('maincomando -> DELETE','maincomando',1,'p_main_comando','gramar.py',170),
  ('maincomando -> COPY','maincomando',1,'p_main_comando','gramar.py',171),
  ('maincomando -> TRANSFER','maincomando',1,'p_main_comando','gramar.py',172),
  ('maincomando -> RENAME','maincomando',1,'p_main_comando','gramar.py',173),
  ('maincomando -> MODIFY','maincomando',1,'p_main_comando','gramar.py',174),
  ('maincomando -> ADD','maincomando',1,'p_main_comando','gramar.py',175),
  ('maincomando -> BACKUP','maincomando',1,'p_main_comando','gramar.py',176),
  ('maincomando -> EXEC','maincomando',1,'p_main_comando','gramar.py',177),
  ('subcomando -> subcomando sub','subcomando',2,'p_subcomando','gramar.py',183),
  ('subcomando -> sub','subcomando',1,'p_subcomando','gramar.py',184),
  ('sub -> TYPE tipo','sub',2,'p_sub','gramar.py',202),
  ('sub -> ENCRYPTLOG encriptado','sub',2,'p_sub','gramar.py',203),
  ('sub -> ENCRYPTREAD encriptado','sub',2,'p_sub','gramar.py',204),
  ('sub -> LLAVE STRING','sub',2,'p_sub','gramar.py',205),
  ('sub -> NAME name','sub',2,'p_sub','gramar.py',206),
  ('sub -> BODY STRING','sub',2,'p_sub','gramar.py',207),
  ('sub -> PATH RUTA','sub',2,'p_sub','gramar.py',208),
  ('sub -> FROM RUTA','sub',2,'p_sub','gramar.py',209),
  ('sub -> TO RUTA','sub',2,'p_sub','gramar.py',210),
  ('sub -> MODE tipo','sub',2,'p_sub','gramar.py',211),
  ('tipo -> LOCAL','tipo',1,'p_tipo','gramar.py',221),
  ('tipo -> CLOUD','tipo',1,'p_tipo','gramar.py',222),
  ('encriptado -> TRUE','encriptado',1,'p_encriptado','gramar.py',228),
  ('encriptado -> FALSE','encriptado',1,'p_encriptado','gramar.py',229),
  ('name -> ARCHIVO','name',1,'p_name','gramar.py',235),
]
