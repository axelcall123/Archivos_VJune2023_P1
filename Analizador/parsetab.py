...
_lr_productions = [
  ...
  ('inicio -> lexico','inicio',1,'p_inicio','gramar.py',114),
  ('lexico -> lexico comandos','lexico',2,'p_lexico','gramar.py',119),
  ('lexico -> comandos','lexico',1,'p_lexico','gramar.py',120),
  ('comandos -> maincomando subcomando','comandos',2,'p_comandos','gramar.py',129),
  ('comandos -> maincomando','comandos',1,'p_comandos','gramar.py',130),
  ('maincomando -> CONFIGURE','maincomando',1,'p_main_comando','gramar.py',145),
  ('maincomando -> CREATE','maincomando',1,'p_main_comando','gramar.py',146),
  ('maincomando -> DELETE','maincomando',1,'p_main_comando','gramar.py',147),
  ('maincomando -> COPY','maincomando',1,'p_main_comando','gramar.py',148),
  ('maincomando -> TRANSFER','maincomando',1,'p_main_comando','gramar.py',149),
  ('maincomando -> RENAME','maincomando',1,'p_main_comando','gramar.py',150),
  ('maincomando -> MODIFY','maincomando',1,'p_main_comando','gramar.py',151),
  ('maincomando -> ADD','maincomando',1,'p_main_comando','gramar.py',152),
  ('maincomando -> BACKUP','maincomando',1,'p_main_comando','gramar.py',153),
  ('maincomando -> EXEC','maincomando',1,'p_main_comando','gramar.py',154),
  ('subcomando -> subcomando sub','subcomando',2,'p_subcomando','gramar.py',160),
  ('subcomando -> sub','subcomando',1,'p_subcomando','gramar.py',161),
  ('sub -> TYPE tipo','sub',2,'p_sub','gramar.py',179),
  ('sub -> ENCRYPTLOG encriptado','sub',2,'p_sub','gramar.py',180),
  ('sub -> ENCRYPTREAD encriptado','sub',2,'p_sub','gramar.py',181),
  ('sub -> LLAVE STRING','sub',2,'p_sub','gramar.py',182),
  ('sub -> NAME name','sub',2,'p_sub','gramar.py',183),
  ('sub -> BODY STRING','sub',2,'p_sub','gramar.py',184),
  ('sub -> PATH RUTA','sub',2,'p_sub','gramar.py',185),
  ('sub -> FROM RUTA','sub',2,'p_sub','gramar.py',186),
  ('sub -> TO RUTA','sub',2,'p_sub','gramar.py',187),
  ('sub -> MODE tipo','sub',2,'p_sub','gramar.py',188),
  ('tipo -> LOCAL','tipo',1,'p_tipo','gramar.py',198),
  ('tipo -> CLOUD','tipo',1,'p_tipo','gramar.py',199),
  ('encriptado -> TRUE','encriptado',1,'p_encriptado','gramar.py',204),
  ('encriptado -> FALSE','encriptado',1,'p_encriptado','gramar.py',205),
  ('name -> ARCHIVO','name',1,'p_name','gramar.py',210),
]
